...
本项目由 @Sevenforweb 制作，灵感来源于某博主（忘记是谁）的平台创作大赛的其中一项作品，时间过久已经忘记是谁了，万分抱歉。本项目与他的实现路径完全不同，且仅支持正版起点小说阅读，完全本地部署，免费免第三方登录。软件全体无毒，不放心的可自行使用 AI 辅助审查。本项目严禁商业化使用，仅供交流学习，不涉及起点集团小说网站的非法爬取，原理为仿真 OCR 识别，不会涉及盗版流出。基于此项目进行软件非法篡改的，与本人无关，后果自负。
